...
class VW_Education_Academy_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'vw-education-academy' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $vw_education_academy_font_awesome_icon_array = vw_education_academy_font_awesome_icon_array();
                    foreach ($vw_education_academy_font_awesome_icon_array as $vw_education_academy_font_awesome_icon) {
                            $icon_class = $this->value() == $vw_education_academy_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($vw_education_academy_font_awesome_icon).'"></i>
                            <span class="vw-education-academy-social-class">'.esc_attr($vw_education_academy_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function vw_education_academy_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'vw-education-academy-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'vw_education_academy_customizer_script' );

if(!function_exists('vw_education_academy_font_awesome_icon_array')){
    function vw_education_academy_font_awesome_icon_array(){
